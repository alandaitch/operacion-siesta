...
[docs/TRANSCRIPT.md](docs/TRANSCRIPT.md) is the complete session that produced this, from the
photograph to the deploy — including every wrong turn above, in the order it happened.
